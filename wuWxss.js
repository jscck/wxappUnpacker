  ...
  function runVM(name,code){
    ...
    let vm = new VM({
      sandbox: Object.assign({}, {
        ...
        $gwx0: GwxCfg.prototype["$gwx"],
        $gwx1: GwxCfg.prototype["$gwx"],
        $gwx2: GwxCfg.prototype["$gwx"],
        $gwx3: GwxCfg.prototype["$gwx"],
        $gwx4: GwxCfg.prototype["$gwx"],
        $gwx5: GwxCfg.prototype["$gwx"],
        $gwx6: GwxCfg.prototype["$gwx"],
        $gwx7: GwxCfg.prototype["$gwx"],
        $gwx8: GwxCfg.prototype["$gwx"],
        $gwx9: GwxCfg.prototype["$gwx"],
        $gwx10: GwxCfg.prototype["$gwx"],
        $gwx11: GwxCfg.prototype["$gwx"],
        $gwx12: GwxCfg.prototype["$gwx"],
        $gwx13: GwxCfg.prototype["$gwx"],
        $gwx14: GwxCfg.prototype["$gwx"],
        $gwx15: GwxCfg.prototype["$gwx"],
        $gwx16: GwxCfg.prototype["$gwx"],
        __mainPageFrameReady__: GwxCfg.prototype["$gwx"], //解决 $gwx is not defined
        __vd_version_info__: {
          delayedGwx: false
        }, //解决__vd_version_info__ is not defined
